...
Feature: User Authentication - Registration, Okta Login, and Forgot Password
  # Functional test cases for QUAL-2: User Registration, Okta Login, and Forgot Password.

  @id:TC-AC1-001 @positive @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-AC2-001 @positive @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-AC3-001 @negative @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-AC4-001 @negative @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-AC5-001 @negative @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-AC6-001 @negative @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-AC7-001 @positive @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-AC8-001 @positive @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-AC9-001 @negative @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-AC10-001 @negative @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-AC11-001 @negative @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-AC12-001 @positive @manual @suite:user-authentication @env:qa @owner:qa-team @priority:p1 @story:QUAL-2
