@suite:user-authentication @env:qa1 @owner:qa-team @story:QUAL-2 @priority:p1
Feature: User Authentication (Registration, Okta Login, and Forgot Password)
  ...
  @id:TC-001 @positive @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-002 @positive @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-003 @negative @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-004 @negative @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-005 @negative @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-006 @negative @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-007 @positive @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-008 @positive @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-009 @negative @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-010 @negative @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-011 @negative @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
  ...
  @id:TC-012 @positive @manual @suite:user-authentication @env:qa1 @owner:qa-team @priority:p1 @story:QUAL-2
